...
%%
t1 = tic;
[sys_l,sn_l,l_l] = clamped_mat(chnkr_l,zk,nu_l,kappa_l,d_l);
[sys_r,sn_r,l_r] = clamped_mat(chnkr_r,zk,nu_r,kappa_r,d_r);

[rhsmat_l,rhsmat0_l,layermat_l,layermat0_l] = precom_clamped_layer(chnkr_tr,chnkr_tr,chnkr_l,1,zk,nu_l,kappa_l,d_l,sn_l,l_l);
[rhsmat_r,rhsmat0_r,layermat_r,layermat0_r] = precom_clamped_layer(chnkr_tr,chnkr_tr,chnkr_r,1,zk,nu_r,kappa_r,d_r,sn_r,l_r);
tpre = toc(t1)

%%
t1 = tic;
data = clamped_scatter_fast(src,chnkr_tr,chnkr_r,1,1,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r,layermat_r,layermat0_r) ...
    - clamped_scatter_fast(src,chnkr_tr,chnkr_l,1,1,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l,layermat_l,layermat0_l);
% data = clamped_scatter_fast(src,chnkr_tr,chnkr_r,1,1,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r,layermat_r,layermat0_r);
trhs = toc(t1)
...
apply_sys = @(dens) Amat*dens ...
    + clamped_layer_fast(chnkr_tr,dens,chnkr_tr,chnkr_r,0,1,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r,rhsmat_r,rhsmat0_r,layermat_r,layermat0_r) ...
    - clamped_layer_fast(chnkr_tr,dens,chnkr_tr,chnkr_l,0,1,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l,rhsmat_l,rhsmat0_l,layermat_l,layermat0_l);
...
ul = clamped_layer_fast(chnkr_tr,dens,targl,chnkr_l,1,0,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l,rhsmat_l,rhsmat0_l,[],[]);
ur = clamped_layer_fast(chnkr_tr,dens,targr,chnkr_r,1,0,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r,rhsmat_r,rhsmat0_r,[],[]);

tlayer = toc(t1)
%%
t1 = tic;
uinl = clamped_scatter(src,targl,chnkr_l,1,0,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l);
uinr = clamped_scatter(src,targr,chnkr_r,1,0,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r);
tin = toc(t1)
%%
...
% plot(real(chnkr_tr.r(2,:)), log10(abs(dens(1:4:end))),'.')
