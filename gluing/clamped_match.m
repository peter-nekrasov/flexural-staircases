...
%%
t1 = tic;
% data = clamped_scatter(src,chnkr_tr,chnkr_r,1,1,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r) ...
%     - clamped_scatter(src,chnkr_tr,chnkr_l,1,1,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l);
data = clamped_scatter(src,chnkr_tr,chnkr_r,1,1,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r);
trhs = toc(t1)
...
apply_sys = @(dens) Amat*dens ...
    + clamped_layer(chnkr_tr,dens,chnkr_tr,chnkr_r,0,1,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r) ...
    - clamped_layer(chnkr_tr,dens,chnkr_tr,chnkr_l,0,1,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l);
...
ul = clamped_layer(chnkr_tr,dens,targl,chnkr_l,1,0,zk,nu_l,kappa_l,d_l,ws_l,sys_l,sn_l,l_l);
ur = clamped_layer(chnkr_tr,dens,targr,chnkr_r,1,0,zk,nu_r,kappa_r,d_r,ws_r,sys_r,sn_r,l_r);
