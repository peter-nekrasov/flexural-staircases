function u = supported_layer(chnkr_tr,dens,targ,chnkr,ifree,itrdata,zk,nu,kappa,d,ws,sys,sn,l)
nkappa = length(kappa);
...
if itrdata == 0
    ...
    ikern = @(s,t) chnk.flex2dquas.kern(zk, s, t, 'supported_plate_eval_trx',kappa,d,sn,[],[],l,1,nu);
    wts = repmat(chnkr.wts(:).',3,1);
