...
if ~isempty(rxclose)
    ...
    if nargout > 3
        D3Js = cat(3,.75*Js(:,:,2) - .25*Js(:,:,4), ...
            ...
            .25*(.5*Js(:,:,1:end-10)-1.5*Js(:,:,3:end-8)+1.5*Js(:,:,5:end-6)-.5*Js(:,:,7:end-4))) *zk^3;
        D3Is = cat(3,.75*Is(:,:,2) - .25*Is(:,:,4), ...
            .25*(2*Is(:,:,3)-.5*Is(:,:,5)-1.5*Is(:,:,1)), ...
            .25*(-2*Is(:,:,2)+1.5*Is(:,:,4)-.5*Is(:,:,6)), ...
            .25*(.5*Is(:,:,1:end-10)-1.5*Is(:,:,3:end-8)+1.5*Is(:,:,5:end-6)-.5*Is(:,:,7:end-4))) *(1i*zk)^3;
    ...
    if nargout > 4
        D4Js = cat(3,.75/2*Js(:,:,1)-1/2*Js(:,:,3)+.25/2*Js(:,:,5), ...
            ...
            .25/2*(    .5*Js(:,:,1:end-11)-2*Js(:,:,3:end-9)+3*Js(:,:,5:end-7)-2*Js(:,:,7:end-5)+.5*Js(:,:,9:end-3))    ) *zk^4;
        D4Is = cat(3,.75/2*Is(:,:,1)-1/2*Is(:,:,3)+.25/2*Is(:,:,5), ...
            ...
            .25/2*(    .5*Is(:,:,1:end-11)-2*Is(:,:,3:end-9)+3*Is(:,:,5:end-7)-2*Is(:,:,7:end-5)+.5*Is(:,:,9:end-3))    ) *zk^4;
    ...
    if nargout > 5
        D5Js = cat(3,-2.5/4*Js(:,:,2)+1.25/4*Js(:,:,4)-.25/4*Js(:,:,6), ...
            ...
            .25/2*(    .5/2*Js(:,:,1:end-12)-2.5/2*Js(:,:,3:end-10) )+3.25/2*Js(:,:,5:end-8)-5/2*Js(:,:,7:end-6)+2.5/2*Js(:,:,9:end-4)-.5/2*Js(:,:,11:end-2)) *zk^5;
        D5Is = cat(3,-2.5/4*Is(:,:,2)+1.25/4*Is(:,:,4)-.25/4*Is(:,:,6), ...
            ...
            .25/2*(  .5/2*Is(:,:,1:end-12)-2.5/2*Is(:,:,3:end-10) )+3.25/2*Is(:,:,5:end-8)-5/2*Is(:,:,7:end-6)+2.5/2*Is(:,:,9:end-4)-.5/2*Is(:,:,11:end-2)) *(1i*zk^5);
    ...
    if nargout > 6
        D6Js = cat(3,-2.5/8*(Js(:,:,1)-Js(:,:,3))+1.25/8*(Js(:,:,3)-Js(:,:,5))-.25/8*(Js(:,:,5)-Js(:,:,7)), ...
            .25*(-2.5/2*Js(:,:,2)-7.5/8*(Js(:,:,2)-Js(:,:,4))+3/8*(Js(:,:,4)-Js(:,:,6))-.5/8*(Js(:,:,6)-Js(:,:,8))), ...
            .25*(   7.5/8*(Js(:,:,1)-Js(:,:,3))-5.5/8*(Js(:,:,3)-Js(:,:,5))+2.5/8*(Js(:,:,5)-Js(:,:,7))-.5/8*(Js(:,:,7)-Js(:,:,9))   ), ...
            .25*(  2.5/4*Js(:,:,2)+5.5/8*(Js(:,:,2)-Js(:,:,4))-5/8*(Js(:,:,4)-Js(:,:,6))+2.5/8*(Js(:,:,6)-Js(:,:,8))-.5/8*(Js(:,:,8)-Js(:,:,10)  )  ), ...
            .25/2*(    -1.5/2*(Js(:,:,1)-Js(:,:,3))+5/4*(Js(:,:,3)-Js(:,:,5))-5/4*(Js(:,:,5)-Js(:,:,7))+2.5/4*(Js(:,:,7)-Js(:,:,9))-.5/4*(Js(:,:,9)-Js(:,:,11))),  ...
            .25/2*(    -.5/2*Js(:,:,1)-2.5/4*(Js(:,:,2)-Js(:,:,4)) )+3.25/4*(Js(:,:,4)-Js(:,:,6))-5/4*(Js(:,:,6)-Js(:,:,8))+2.5/4*(Js(:,:,8)-Js(:,:,10))-.5/4*(Js(:,:,10)-Js(:,:,12)), ...
            .25/2*(    .5/4*(Js(:,:,1:end-13)-Js(:,:,3:end-11))-2.5/4*(Js(:,:,3:end-11)-Js(:,:,5:end-9)) )+3.25/4*(Js(:,:,5:end-9)-Js(:,:,7:end-7))-5/4*(Js(:,:,7:end-7)-Js(:,:,9:end-5))+2.5/4*(Js(:,:,9:end-5)-Js(:,:,11:end-3))-.5/4*(Js(:,:,11:end-3)-Js(:,:,13:end-1))) *zk^6;
        D6Is = cat(3,-2.5/8*(Is(:,:,1)-Is(:,:,3))+1.25/8*(Is(:,:,3)-Is(:,:,5))-.25/8*(Is(:,:,5)-Is(:,:,7)), ...
            .25*(-2.5/2*Is(:,:,2)-7.5/8*(Is(:,:,2)-Is(:,:,4))+3/8*(Is(:,:,4)-Is(:,:,6))-.5/8*(Is(:,:,6)-Is(:,:,8))), ...
            .25*(   7.5/8*(Is(:,:,1)-Is(:,:,3))-5.5/8*(Is(:,:,3)-Is(:,:,5))+2.5/8*(Is(:,:,5)-Is(:,:,7))-.5/8*(Is(:,:,7)-Is(:,:,9))   ), ...
            .25*(  2.5/4*Is(:,:,2)+5.5/8*(Is(:,:,2)-Is(:,:,4))-5/8*(Is(:,:,4)-Is(:,:,6))+2.5/8*(Is(:,:,6)-Is(:,:,8))-.5/8*(Is(:,:,8)-Is(:,:,10)  )  ), ...
            .25/2*(    -1.5/2*(Is(:,:,1)-Is(:,:,3))+5/4*(Is(:,:,3)-Is(:,:,5))-5/4*(Is(:,:,5)-Is(:,:,7))+2.5/4*(Is(:,:,7)-Is(:,:,9))-.5/4*(Is(:,:,9)-Is(:,:,11))),  ...
            .25/2*(    -.5/2*Is(:,:,1)-2.5/4*(Is(:,:,2)-Is(:,:,4)) )+3.25/4*(Is(:,:,4)-Is(:,:,6))-5/4*(Is(:,:,6)-Is(:,:,8))+2.5/4*(Is(:,:,8)-Is(:,:,10))-.5/4*(Is(:,:,10)-Is(:,:,12)), ...
            .25/2*(    .5/4*(Is(:,:,1:end-13)-Is(:,:,3:end-11))-2.5/4*(Is(:,:,3:end-11)-Is(:,:,5:end-9)) )+3.25/4*(Is(:,:,5:end-9)-Is(:,:,7:end-7))-5/4*(Is(:,:,7:end-7)-Is(:,:,9:end-5))+2.5/4*(Is(:,:,9:end-5)-Is(:,:,11:end-3))-.5/4*(Is(:,:,11:end-3)-Is(:,:,13:end-1))) *(1i*zk)^6;
