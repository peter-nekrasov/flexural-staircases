...
if ~isempty(rxclose)
    ...
    if nargout > 4
        D4Js = cat(3,.75/2*(Js(:,:,1)-Js(:,:,3)) - .25/2*(Js(:,:,3)-Js(:,:,5)), ...
            ...
            .25/2*(.5*(Js(:,:,1:end-10)-Js(:,:,3:end-8))-1.5*(Js(:,:,3:end-8)-Js(:,:,5:end-6))+1.5*(Js(:,:,5:end-6)-Js(:,:,7:end-4))-.5*(Js(:,:,7:end-4)-Js(:,:,9:end-2)))) *zk^4;
        D4Is = cat(3,.75/2*(Is(:,:,1)-Is(:,:,3)) - .25/2*(Is(:,:,3)-Is(:,:,5)), ...
            ...
            .25/2*(.5*(Is(:,:,1:end-10)-Is(:,:,3:end-8))-1.5*(Is(:,:,3:end-8)-Is(:,:,5:end-6))+1.5*(Is(:,:,5:end-6)-Is(:,:,7:end-4))-.5*(Is(:,:,7:end-4)-Is(:,:,9:end-2))))  *(1i*zk)^4;
