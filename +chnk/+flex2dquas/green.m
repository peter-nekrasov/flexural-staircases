...
if ~isempty(rxclose)
    for i = ls
        ...
        rxi = rxclose - i*d;
        if nargout>6
        [vali,gradi,hessi,thirdi,fourthi,fifthi,sixthi] = hkdiffgreen1(zk,[0;0],[rxi.';ryclose.']);
    ...
    if nargout > 5
        D5Js = cat(3,-2.5/4*Js(:,:,2)+1.25/4*Js(:,:,4)-.25/4*Js(:,:,6), ...
            .25*(2.5/2*Js(:,:,1)-7.5/4*Js(:,:,3)+3/4*Js(:,:,5)-.5/4*Js(:,:,7)), ...
            .25*(   7.5/4*Js(:,:,2)-5.5/4*Js(:,:,4)+2.5/4*Js(:,:,6)-.5/4*Js(:,:,8)   ), ...
            .25*(  -2.5/4*Js(:,:,1)+5.5/4*Js(:,:,3)-5/4*Js(:,:,5)+2.5/4*Js(:,:,7)-.5/4*Js(:,:,9)   ), ...
            .25/2*(    -1.5*Js(:,:,2)+5/2*Js(:,:,4)-5/2*Js(:,:,6)+2.5/2*Js(:,:,8)-.5/2*Js(:,:,10)),  ...
            .25/2*(    .5/2*Js(:,:,1:end-11)-2.5/2*Js(:,:,3:end-9) )+3.25/2*Js(:,:,5:end-7)-5/2*Js(:,:,7:end-5)+2.5/2*Js(:,:,9:end-3)-.5/2*Js(:,:,11:end-1)) *zk^5;
        D5Is = cat(3,-2.5/4*Is(:,:,2)+1.25/4*Is(:,:,4)-.25/4*Is(:,:,6), ...
            .25*(2.5/2*Is(:,:,1)-7.5/4*Is(:,:,3)+3/4*Is(:,:,5)-.5/4*Is(:,:,7)), ...
            .25*(    7.5/4*Is(:,:,2)-5.5/4*Is(:,:,4)+2.5/4*Is(:,:,6)-.5/4*Is(:,:,8)   ), ...
            .25*(  -2.5/4*Is(:,:,1)+5.5/4*Is(:,:,3)-5/4*Is(:,:,5)+2.5/4*Is(:,:,7)-.5/4*Is(:,:,9)   ), ...
            .25/2*(   -1.5*Is(:,:,2)+5/2*Is(:,:,4)-5/2*Is(:,:,6)+2.5/2*Is(:,:,8)-.5/2*Is(:,:,10)),  ...
            .25/2*(  .5/2*Is(:,:,1:end-11)-2.5/2*Is(:,:,3:end-9) )+3.25/2*Is(:,:,5:end-7)-5/2*Is(:,:,7:end-5)+2.5/2*Is(:,:,9:end-3)-.5/2*Is(:,:,11:end-1)) *(1i*zk^5);
