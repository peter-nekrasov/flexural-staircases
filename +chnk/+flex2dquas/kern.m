...
case {'free_plate_bcs_trx'}
    ...
    2*nu/(2*zk^2).*(fourth(:, :, 3).*(tauxtarg.*tauxtarg) + fourth(:, :, 4).*(2*tauxtarg.*tauytarg) + fourth(:, :, 5).*(tauytarg.*tauytarg));
    ...
    2*(2-nu)/(2*zk^2).*(fifth(:, :, 3).*(tauxtarg.*tauxtarg.*nxtarg) + fifth(:, :, 4).*(tauxtarg.*tauxtarg.*nytarg + 2*tauxtarg.*tauytarg.*nxtarg) +...
    fifth(:, :, 5).*(2*tauxtarg.*tauytarg.*nytarg+ tauytarg.*tauytarg.*nxtarg) +...
    + fifth(:, :, 6).*(tauytarg.*tauytarg.*nytarg))+...
    2*(1-nu).*kappatarg.*(1/(2*zk^2).*(fourth(:, :, 3).*tauxtarg.*tauxtarg + fourth(:, :, 4).*(2*tauxtarg.*tauytarg) + fourth(:, :, 5).*tauytarg.*tauytarg)-...
    2*(1/(2*zk^2).*(fourth(:, :, 3).*nxtarg.*nxtarg + fourth(:, :, 4).*(2*nxtarg.*nytarg) + fourth(:, :, 5).*nytarg.*nytarg)));
    ...
    2*nu/(2*zk^2).*(fifth(:, :, 3).*(tauxtarg.*tauxtarg) + fifth(:, :, 4).*(2*tauxtarg.*tauytarg) + fifth(:, :, 5).*(tauytarg.*tauytarg));
    ...
    2*(2-nu)/(2*zk^2).*(sixth(:, :, 3).*(tauxtarg.*tauxtarg.*nxtarg) + sixth(:, :, 4).*(tauxtarg.*tauxtarg.*nytarg + 2*tauxtarg.*tauytarg.*nxtarg) +...
    sixth(:, :, 5).*(2*tauxtarg.*tauytarg.*nytarg+ tauytarg.*tauytarg.*nxtarg) +...
    + sixth(:, :, 6).*(tauytarg.*tauytarg.*nytarg))+...
    2*(1-nu).*kappatarg.*(1/(2*zk^2).*(fifth(:, :, 3).*tauxtarg.*tauxtarg + fifth(:, :, 4).*(2*tauxtarg.*tauytarg) + fifth(:, :, 5).*tauytarg.*tauytarg)-...
    2*(1/(2*zk^2).*(fifth(:, :, 3).*nxtarg.*nxtarg + fifth(:, :, 4).*(2*nxtarg.*nytarg) + fifth(:, :, 5).*nytarg.*nytarg)));
