...
poles{i} = supported_mode(chnkr,nu,kappa,kmin,kmax,d,tol);
...
function modes = supported_mode(chnkr,nu,kappa,kmin,kmax,d,tol)
...
for j = 1:nref
    ...
    for k = 1:size(pan_ref,2)
        ...
        for i = 1:ncheb
            sys = supported_mat(chnkr,zks(i),nu,kappa,d);
